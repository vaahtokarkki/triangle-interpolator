...
public class MyColors {
     ...
     */
    public static final Color[] DIVERGING = { new Color(158, 1, 66), new Color(181, 26, 71), new Color(204, 52, 77),
            new Color(221, 74, 76), new Color(234, 93, 71), new Color(245, 114, 70), new Color(249, 142, 82),
            new Color(252, 169, 95), new Color(253, 191, 111), new Color(254, 212, 129), new Color(254, 229, 148),
            new Color(255, 242, 169), new Color(255, 255, 191), new Color(245, 251, 175), new Color(234, 247, 158),
            new Color(215, 239, 155), new Color(191, 229, 160), new Color(165, 219, 164), new Color(137, 208, 165),
    ...
    /**
     * Get a color from diverging color scheme, mapped to given class when specified
     * amount of classes. Zero value (or middle), approx white or light orange on
     * index 12.
     * 
     * @param currentClass class to get color for
     * @param classes      total amount of classes used
